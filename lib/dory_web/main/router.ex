defmodule DoryWeb.Router do
  ...
  import DoryWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {DoryWeb.Layouts, :root}
  ...
  if Application.compile_env(:dory, :dev_routes) do
  ...
  scope "/", DoryWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{DoryWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", DoryWeb do
    ...
    live_session :current_user,
      on_mount: [{DoryWeb.UserAuth, :mount_current_user}] do
